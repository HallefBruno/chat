...
// ----------------------------------------------------------------------------
var AUTH0_CONFIG = {
    domain: "dev-wledwmc0pae8ohr0.us.auth0.com", // <-- TODO informar "domain"
    clientId: "WWwveHlW6rjza1HTNMTSc1zpEtj26DAc", // <-- TODO informar "clientId"
...
function getAuth0Client() {
    ...
    return auth0.createAuth0Client(AUTH0_CONFIG).then(function (client) {
